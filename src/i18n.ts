...
const en: Dict = {
  ...
  "widget.lock": "Lock widget position",
  "widget.unlock": "Unlock widget position",
  ...
  "metric.planCredits": "Plan Credits",
  "metric.planTier": "Plan tier",
  "metric.wallet": "Wallet",
  "metric.api": "API",
  ...
  "metric.weeklyCapacity": "Weekly capacity",
  "metric.cloudCredits": "Cloud credits",
  "cap.thisWeek": "This week",
  "cap.observedSoFar": "Observed so far",
  "cap.estAt100": "Estimated at 100%",
  "cap.pastWeeks": "Past weeks",
  "cap.observed": "Observed",
  "cap.finalizing": "finalizing",
  "cap.incompletePeak": "Incomplete (peak {n}%)",
  "cap.avg": "Average of observed weeks",
  "cap.footnote": "API-equivalent value from this PC's logs — not what you pay. Usage on other devices isn't counted.",
  "cap.valueEst": "≈ {cost} · {n} tokens",
  "cap.valueObserved": "{cost} · {n} tokens",
...
const zh: Dict = {
  ...
  "card.expiresSoon": "即将过期",
  "card.expiresIn": "{time}后过期",
  "card.expired": "已过期",
  "card.expiredAt": "{when} 已过期",
  "card.available": "可用",
  ...
  "metric.planCredits": "套餐额度",
  "metric.planTier": "套餐档位",
  "metric.wallet": "钱包",
  "metric.api": "API",
  "metric.balance": "余额",
  "metric.vouchers": "代金券",
  ...
  "metric.weeklyCapacity": "每周容量",
  "metric.cloudCredits": "云端额度",
  "cap.thisWeek": "本周",
  "cap.observedSoFar": "目前已观测",
  "cap.estAt100": "100% 预估",
  "cap.pastWeeks": "历史周",
  "cap.observed": "已观测",
  "cap.finalizing": "统计中",
  "cap.incompletePeak": "不完整（峰值 {n}%）",
  "cap.avg": "已观测周平均",
  "cap.footnote": "按 API 价格从本机日志折算——并非你的实际账单。其他设备上的用量不计入。",
  "cap.valueEst": "≈ {cost} · {n} tokens",
  "cap.valueObserved": "{cost} · {n} tokens",
...
const ru: Dict = {
  ...
  "widget.lock": "Закрепить положение виджета",
  "widget.unlock": "Открепить положение виджета",
  ...
  "card.expiresSoon": "Скоро истечёт",
  "card.expiresIn": "Истекает через {time}",
  "card.expired": "Истекло",
  "card.expiredAt": "Истекло {when}",
  ...
  "metric.planCredits": "Кредиты плана",
  "metric.planTier": "Тариф плана",
  "metric.wallet": "Кошелёк",
  "metric.api": "API",
  ...
  "metric.weeklyCapacity": "Недельная ёмкость",
  "metric.cloudCredits": "Облачные кредиты",
  "cap.thisWeek": "Эта неделя",
  "cap.observedSoFar": "Пока наблюдено",
  "cap.estAt100": "Оценка при 100%",
  "cap.pastWeeks": "Прошлые недели",
  "cap.observed": "Полная",
  "cap.finalizing": "уточняется",
  "cap.incompletePeak": "Неполная (пик {n}%)",
  "cap.avg": "Среднее по полным неделям",
  "cap.footnote": "Эквивалент цены API по логам этого ПК — не сумма к оплате. Использование на других устройствах не учитывается.",
  "cap.valueEst": "≈ {cost} · {n} tokens",
  "cap.valueObserved": "{cost} · {n} tokens",
...
const METRIC_KEYS: Record<string, string> = {
  ...
  "Plan Credits": "metric.planCredits",
  "Plan tier": "metric.planTier",
  ...
  "Weekly capacity": "metric.weeklyCapacity",
  "Cloud credits": "metric.cloudCredits",
